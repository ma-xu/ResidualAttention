#!/bin/bash
#BATCH --job-name=SoftmaxSEResNet50
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 /home/xm0036/ResidualAttention/cifar.py --netName=SoftmaxSEResNet50 --bs=512 --cifar=100
