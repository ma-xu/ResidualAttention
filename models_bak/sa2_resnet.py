...
channel_mean->conv(3,1)->conv(3,2)->upsampling->conv(3,1)->sigmoid
...
__all__ = ['SA2ResNet18', 'SA2ResNet34', 'SA2ResNet50', 'SA2ResNet101', 'SA2ResNet152']
...
class SALayer(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(1, 1, kernel_size=3, stride=2, padding=1, bias=True)
        # self.upsampling = nn.ConvTranspose2d(1, 1, kernel_size=3, stride=2, padding=1, bias=True)
