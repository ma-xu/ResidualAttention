...
__all__ = ['SAResNet18', 'SAResNet34', 'SAResNet50', 'SAResNet101', 'SAResNet152']
...
def test():
    ...
    # print(y.size())
    # print(y)
    net = SAResNet18(num_classes=100)
