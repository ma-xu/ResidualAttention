...
class SSELayer(nn.Module):
    def __init__(self, channel, reduction=16,enlarge=2):
    ...
    def forward(self, x):
        ...
        y = self.fc(y)
        y = torch.sigmoid(self.enlarge*y)
        y = y.view(b, c, 1, 1)
...
class PreActBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.se = SSELayer(planes*self.expansion)
