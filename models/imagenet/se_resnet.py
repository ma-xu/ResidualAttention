...
def se_resnet18(num_classes=1000):
    model = SEResNet(BasicBlock, [2, 2, 2, 2], num_classes)
    return model


def se_resnet34(num_classes=1000):
    model = SEResNet(BasicBlock, [3, 4, 6, 3], num_classes)
    return model


def se_resnet50(num_classes=1000):
    model = SEResNet(Bottleneck, [3, 4, 6, 3], num_classes)
    return model


def se_resnet101(num_classes=1000):
    model = SEResNet(Bottleneck, [3, 4, 23, 3], num_classes)
    return model


def se_resnet152(num_classes=1000):
    model = SEResNet(Bottleneck, [3, 8, 36, 3], num_classes)
    return model


def test():
    net = se_resnet152(num_classes=100)
